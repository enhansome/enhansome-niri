...
[niri](https://github.com/niri-wm/niri) ⭐ 26,947 | 🐛 486 | 🌐 Rust | 📅 2026-08-14 is a scrollable-tiling Wayland compositor. This is a curated list of resources related to niri.
...
* [niri-flake](https://github.com/epireyn/niri-flake) ⭐ 64 | 🐛 2 | 🌐 Nix | 📅 2026-08-16 - A Nix flake with cached binary builds and batteries-included modules (actively maintained fork of [sodiboo/niri-flake](https://github.com/sodiboo/niri-flake) ⭐ 970 | 🐛 78 | 🌐 Nix | 📅 2026-08-16).
...
* [miri](https://github.com/MintyDoggo/miri) ⭐ 101 | 🐛 11 | 🌐 Rust | 📅 2026-06-21 - A niri extension adding per-workspace tiling layouts, such as Master Stack, similar to hyprland or mangowm.
...
* [Anyrun](https://github.com/anyrun-org/anyrun) ⭐ 1,289 | 🐛 72 | 🌐 Rust | 📅 2026-08-14 - A Wayland native krunner-like runner, made with customizability in mind. Provides [niri-focus](https://github.com/anyrun-org/anyrun/blob/master/plugins/niri-focus/README.md) ⭐ 1,289 | 🐛 72 | 🌐 Rust | 📅 2026-08-14 plugin.
...
* [shaders](https://github.com/liixini/shaders) ⭐ 209 | 🐛 0 | 🌐 GLSL | 📅 2026-07-23 - A collection of custom shaders.

## Bars and Widgets

* [Waybar](https://github.com/Alexays/Waybar) ⭐ 11,809 | 🐛 711 | 🌐 C++ | 📅 2026-08-14 - Highly customizable Wayland bar based on GTK.
* [Ironbar](https://github.com/JakeStanger/ironbar) ⭐ 1,432 | 🐛 123 | 🌐 Rust | 📅 2026-08-10 - A customisable Wayland GTK bar written in Rust.
* [ashell](https://github.com/MalpenZibo/ashell) ⭐ 1,067 | 🐛 105 | 🌐 Rust | 📅 2026-08-14 - A ready to go Wayland status bar.
* [Ignis](https://github.com/linkfrg/ignis) ⭐ 678 | 🐛 66 | 🌐 Python | 📅 2026-08-14 - A widget framework for building desktop shells, written and configurable in Python.
* [vibepanel](https://github.com/prankstr/vibepanel) ⭐ 160 | 🐛 4 | 🌐 Rust | 📅 2026-08-15 - A GTK4 panel for Wayland with integrated notifications, OSD, and quick settings.
* [Niri Taskbar](https://github.com/LawnGnome/niri-taskbar) ⭐ 151 | 🐛 29 | 🌐 Rust | 📅 2025-12-04 - Provides a Waybar taskbar module for niri.
* [i3bar-river](https://github.com/MaxVerevkin/i3bar-river) ⭐ 86 | 🐛 23 | 🌐 Rust | 📅 2025-05-19 - A port of i3bar for Wayland compositors, to be used with something like [i3status-rust](https://github.com/greshake/i3status-rust) ⭐ 3,134 | 🐛 120 | 🌐 Rust | 📅 2026-08-15.
...
* [Noctalia](https://github.com/Ly-sec/Noctalia) ⭐ 9,562 | 🐛 250 | 🌐 C++ | 📅 2026-08-16 - A sleek and minimal desktop shell built with Quickshell.
* [DankMaterialShell](https://github.com/AvengeMedia/DankMaterialShell) ⭐ 7,614 | 🐛 441 | 🌐 QML | 📅 2026-08-16 - Quickshell based shell featuring Material 3 design principles, with a heavy focus on functionality and customizability.
* [iNiR](https://github.com/snowarch/iNiR) ⭐ 1,423 | 🐛 22 | 🌐 QML | 📅 2026-08-12 - [end-4's quickshell config](https://github.com/end-4/dots-hyprland) ⭐ 15,614 | 🐛 629 | 🌐 QML | 📅 2026-08-15 modified to work with niri.
...
* [GPUi Shell](https://github.com/andre-brandao/gpui-shell) ⭐ 117 | 🐛 2 | 🌐 Rust | 📅 2026-08-07 - A GPUI based shell written in Rust.
...
* [niri on LXQt](https://lxqt-project.org) - LXQt is a lightweight Qt-based desktop environment that allows setting [niri as compositor](https://github.com/lxqt/lxqt/wiki/ConfigWaylandSettings) ⭐ 1,859 | 🐛 176 | 🌐 Shell | 📅 2026-05-17, while its modules can also be used standalone in `niri-session`.
* [niri on Cosmic](https://github.com/Drakulix/cosmic-ext-extra-sessions) ⭐ 181 | 🐛 15 | 🌐 Shell | 📅 2025-04-02 - A Cosmic extension that allows niri as a session option, allowing you to use niri with the [Cosmic desktop environment](https://github.com/pop-os/cosmic-epoch) ⭐ 6,641 | 🐛 1,794 | 🌐 Just | 📅 2026-07-29.
...
* [Setup Showcase](https://github.com/niri-wm/niri/discussions/325) ⭐ 26,947 | 🐛 486 | 🌐 Rust | 📅 2026-08-14 - A showcase of niri setups, where users can share their configurations and get inspiration from others.
* [OOTB setups](https://github.com/Vortriz/awesome-niri/discussions/30) ⭐ 1,405 | 🐛 0 | 🌐 Nix | 📅 2026-08-10 - A collection of out-of-the-box niri configurations that can be easily installed to get a fully functional setup quickly.

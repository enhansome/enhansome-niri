...
[niri](https://github.com/niri-wm/niri) ⭐ 26,920 | 🐛 486 | 🌐 Rust | 📅 2026-08-14 is a scrollable-tiling Wayland compositor. This is a curated list of resources related to niri.
...
* [niri-flake](https://github.com/epireyn/niri-flake) ⭐ 63 | 🐛 2 | 🌐 Nix | 📅 2026-08-14 - A Nix flake with cached binary builds and batteries-included modules (actively maintained fork of [sodiboo/niri-flake](https://github.com/sodiboo/niri-flake) ⭐ 970 | 🐛 78 | 🌐 Nix | 📅 2026-08-15).
...
* [niri-sidebar](https://github.com/Vigintillionn/niri-sidebar) ⭐ 171 | 🐛 10 | 🌐 Rust | 📅 2026-05-16 - Manage windows using a floating sidebar.
...
* [nirinit](https://github.com/amaanq/nirinit) ⭐ 74 | 🐛 4 | 🌐 Rust | 📅 2026-03-25 - Session manager that automatically saves and restores your window layout.
...
* [Anyrun](https://github.com/anyrun-org/anyrun) ⭐ 1,288 | 🐛 72 | 🌐 Rust | 📅 2026-08-14 - A Wayland native krunner-like runner, made with customizability in mind. Provides [niri-focus](https://github.com/anyrun-org/anyrun/blob/master/plugins/niri-focus/README.md) ⭐ 1,288 | 🐛 72 | 🌐 Rust | 📅 2026-08-14 plugin.
* [Stasis](https://github.com/saltnpepper97/stasis) ⭐ 173 | 🐛 7 | 🌐 Rust | 📅 2026-08-15 - A modern Wayland idle manager with smart timeouts, media awareness, and app-specific inhibition.
...
* [nirimod](https://github.com/srinivasr/nirimod) ⭐ 374 | 🐛 4 | 🌐 Python | 📅 2026-08-02 - A visual, interactive configuration interface.
...
* [shaders](https://github.com/liixini/shaders) ⭐ 208 | 🐛 0 | 🌐 GLSL | 📅 2026-07-23 - A collection of custom shaders.

## Bars and Widgets

* [Waybar](https://github.com/Alexays/Waybar) ⭐ 11,794 | 🐛 711 | 🌐 C++ | 📅 2026-08-14 - Highly customizable Wayland bar based on GTK.
* [Ironbar](https://github.com/JakeStanger/ironbar) ⭐ 1,432 | 🐛 123 | 🌐 Rust | 📅 2026-08-10 - A customisable Wayland GTK bar written in Rust.
* [ashell](https://github.com/MalpenZibo/ashell) ⭐ 1,065 | 🐛 102 | 🌐 Rust | 📅 2026-08-14 - A ready to go Wayland status bar.
* [Ignis](https://github.com/linkfrg/ignis) ⭐ 677 | 🐛 66 | 🌐 Python | 📅 2026-08-14 - A widget framework for building desktop shells, written and configurable in Python.
* [vibepanel](https://github.com/prankstr/vibepanel) ⭐ 158 | 🐛 2 | 🌐 Rust | 📅 2026-08-15 - A GTK4 panel for Wayland with integrated notifications, OSD, and quick settings.
* [Niri Taskbar](https://github.com/LawnGnome/niri-taskbar) ⭐ 151 | 🐛 29 | 🌐 Rust | 📅 2025-12-04 - Provides a Waybar taskbar module for niri.
* [i3bar-river](https://github.com/MaxVerevkin/i3bar-river) ⭐ 86 | 🐛 23 | 🌐 Rust | 📅 2025-05-19 - A port of i3bar for Wayland compositors, to be used with something like [i3status-rust](https://github.com/greshake/i3status-rust) ⭐ 3,133 | 🐛 121 | 🌐 Rust | 📅 2026-08-11.
...
* [Noctalia](https://github.com/Ly-sec/Noctalia) ⭐ 9,531 | 🐛 241 | 🌐 C++ | 📅 2026-08-15 - A sleek and minimal desktop shell built with Quickshell.
* [DankMaterialShell](https://github.com/AvengeMedia/DankMaterialShell) ⭐ 7,601 | 🐛 440 | 🌐 QML | 📅 2026-08-15 - Quickshell based shell featuring Material 3 design principles, with a heavy focus on functionality and customizability.
* [iNiR](https://github.com/snowarch/iNiR) ⭐ 1,417 | 🐛 21 | 🌐 QML | 📅 2026-08-12 - [end-4's quickshell config](https://github.com/end-4/dots-hyprland) ⭐ 15,605 | 🐛 629 | 🌐 QML | 📅 2026-08-15 modified to work with niri.
...
* [GPUi Shell](https://github.com/andre-brandao/gpui-shell) ⭐ 116 | 🐛 2 | 🌐 Rust | 📅 2026-08-07 - A GPUI based shell written in Rust.
...
* [niri on Cosmic](https://github.com/Drakulix/cosmic-ext-extra-sessions) ⭐ 181 | 🐛 15 | 🌐 Shell | 📅 2025-04-02 - A Cosmic extension that allows niri as a session option, allowing you to use niri with the [Cosmic desktop environment](https://github.com/pop-os/cosmic-epoch) ⭐ 6,640 | 🐛 1,791 | 🌐 Just | 📅 2026-07-29.
...
* [Setup Showcase](https://github.com/niri-wm/niri/discussions/325) ⭐ 26,920 | 🐛 486 | 🌐 Rust | 📅 2026-08-14 - A showcase of niri setups, where users can share their configurations and get inspiration from others.
* [OOTB setups](https://github.com/Vortriz/awesome-niri/discussions/30) ⭐ 1,396 | 🐛 0 | 🌐 Nix | 📅 2026-08-10 - A collection of out-of-the-box niri configurations that can be easily installed to get a fully functional setup quickly.

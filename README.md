...
[niri](https://github.com/niri-wm/niri) ⭐ 27,057 | 🐛 477 | 🌐 Rust | 📅 2026-08-19 is a scrollable-tiling Wayland compositor. This is a curated list of resources related to niri.
...
* [niri-flake](https://github.com/epireyn/niri-flake) ⭐ 73 | 🐛 2 | 🌐 Nix | 📅 2026-08-21 - A Nix flake with cached binary builds and batteries-included modules (actively maintained fork of [sodiboo/niri-flake](https://github.com/sodiboo/niri-flake) ⭐ 973 | 🐛 78 | 🌐 Nix | 📅 2026-08-20).
...
* [oniri](https://github.com/Antiz96/oniri) ⭐ 48 | 🐛 1 | 🌐 Rust | 📅 2026-08-18 - A tool that automatically maximizes the only window in a workspace.
...
* [niri-session-manager](https://github.com/MTeaHead/niri-session-manager) ⭐ 78 | 🐛 2 | 🌐 Rust | 📅 2025-07-25 - Automatically save and restore windows.
...
* [wayvid](https://github.com/YangYuS8/wayvid) ⭐ 130 | 🐛 16 | 🌐 Rust | 📅 2026-07-20 - A dynamic video wallpaper engine for Wayland compositors.
...
* [Anyrun](https://github.com/anyrun-org/anyrun) ⭐ 1,293 | 🐛 73 | 🌐 Rust | 📅 2026-08-14 - A Wayland native krunner-like runner, made with customizability in mind. Provides [niri-focus](https://github.com/anyrun-org/anyrun/blob/master/plugins/niri-focus/README.md) ⭐ 1,293 | 🐛 73 | 🌐 Rust | 📅 2026-08-14 plugin.
* [Stasis](https://github.com/saltnpepper97/stasis) ⭐ 176 | 🐛 4 | 🌐 Rust | 📅 2026-08-15 - A modern Wayland idle manager with smart timeouts, media awareness, and app-specific inhibition.
...
* [nirimod](https://github.com/srinivasr/nirimod) ⭐ 378 | 🐛 5 | 🌐 Python | 📅 2026-08-02 - A visual, interactive configuration interface.
...
* [shaders](https://github.com/liixini/shaders) ⭐ 214 | 🐛 0 | 🌐 GLSL | 📅 2026-07-23 - A collection of custom shaders.

## Bars and Widgets

* [Waybar](https://github.com/Alexays/Waybar) ⭐ 11,827 | 🐛 713 | 🌐 C++ | 📅 2026-08-20 - Highly customizable Wayland bar based on GTK.
* [Ironbar](https://github.com/JakeStanger/ironbar) ⭐ 1,438 | 🐛 120 | 🌐 Rust | 📅 2026-08-20 - A customisable Wayland GTK bar written in Rust.
* [ashell](https://github.com/MalpenZibo/ashell) ⭐ 1,069 | 🐛 102 | 🌐 Rust | 📅 2026-08-20 - A ready to go Wayland status bar.
* [Ignis](https://github.com/linkfrg/ignis) ⭐ 679 | 🐛 66 | 🌐 Python | 📅 2026-08-18 - A widget framework for building desktop shells, written and configurable in Python.
* [vibepanel](https://github.com/prankstr/vibepanel) ⭐ 161 | 🐛 4 | 🌐 Rust | 📅 2026-08-21 - A GTK4 panel for Wayland with integrated notifications, OSD, and quick settings.
* [Niri Taskbar](https://github.com/LawnGnome/niri-taskbar) ⭐ 151 | 🐛 29 | 🌐 Rust | 📅 2025-12-04 - Provides a Waybar taskbar module for niri.
* [i3bar-river](https://github.com/MaxVerevkin/i3bar-river) ⭐ 86 | 🐛 23 | 🌐 Rust | 📅 2025-05-19 - A port of i3bar for Wayland compositors, to be used with something like [i3status-rust](https://github.com/greshake/i3status-rust) ⭐ 3,138 | 🐛 120 | 🌐 Rust | 📅 2026-08-15.
...
* [Noctalia](https://github.com/Ly-sec/Noctalia) ⭐ 9,706 | 🐛 280 | 🌐 C++ | 📅 2026-08-21 - A sleek and minimal desktop shell built with Quickshell.
* [DankMaterialShell](https://github.com/AvengeMedia/DankMaterialShell) ⭐ 7,677 | 🐛 440 | 🌐 QML | 📅 2026-08-21 - Quickshell based shell featuring Material 3 design principles, with a heavy focus on functionality and customizability.
* [iNiR](https://github.com/snowarch/iNiR) ⭐ 1,453 | 🐛 17 | 🌐 QML | 📅 2026-08-20 - [end-4's quickshell config](https://github.com/end-4/dots-hyprland) ⭐ 15,700 | 🐛 637 | 🌐 QML | 📅 2026-08-15 modified to work with niri.
* [Exo](https://github.com/debuggyo/Exo) ⭐ 688 | 🐛 13 | 🌐 Python | 📅 2026-01-16 - A Material 3 inspired desktop shell created with Ignis.
...
* [GPUi Shell](https://github.com/andre-brandao/gpui-shell) ⭐ 122 | 🐛 2 | 🌐 Rust | 📅 2026-08-07 - A GPUI based shell written in Rust.
...
* [Glimpse](https://github.com/alex-oleshkevich/glimpse) ⭐ 10 | 🐛 1 | 🌐 Rust | 📅 2026-08-18 - A niri-first Wayland desktop shell toolkit with a panel, wallpaper, lock screen, night light, and idle management.
* [Niri GTK](https://github.com/sameoldlab/niri-gtk) ⭐ 4 | 🐛 0 | 🌐 Vala | 📅 2026-08-18 - GTK bindings to niri IPC.

## DE Integration

* [niri on LXQt](https://lxqt-project.org) - LXQt is a lightweight Qt-based desktop environment that allows setting [niri as compositor](https://github.com/lxqt/lxqt/wiki/ConfigWaylandSettings) ⭐ 1,862 | 🐛 173 | 🌐 Shell | 📅 2026-05-17, while its modules can also be used standalone in `niri-session`.
* [niri on Cosmic](https://github.com/Drakulix/cosmic-ext-extra-sessions) ⭐ 181 | 🐛 15 | 🌐 Shell | 📅 2025-04-02 - A Cosmic extension that allows niri as a session option, allowing you to use niri with the [Cosmic desktop environment](https://github.com/pop-os/cosmic-epoch) ⭐ 6,684 | 🐛 1,794 | 🌐 Just | 📅 2026-08-20.
...
* [Setup Showcase](https://github.com/niri-wm/niri/discussions/325) ⭐ 27,057 | 🐛 477 | 🌐 Rust | 📅 2026-08-19 - A showcase of niri setups, where users can share their configurations and get inspiration from others.
* [OOTB setups](https://github.com/Vortriz/awesome-niri/discussions/30) ⭐ 1,407 | 🐛 0 | 🌐 Nix | 📅 2026-08-19 - A collection of out-of-the-box niri configurations that can be easily installed to get a fully functional setup quickly.

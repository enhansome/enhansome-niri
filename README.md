...
[niri](https://github.com/niri-wm/niri) ⭐ 26,961 | 🐛 488 | 🌐 Rust | 📅 2026-08-14 is a scrollable-tiling Wayland compositor. This is a curated list of resources related to niri.
...
* [niri-flake](https://github.com/epireyn/niri-flake) ⭐ 66 | 🐛 2 | 🌐 Nix | 📅 2026-08-17 - A Nix flake with cached binary builds and batteries-included modules (actively maintained fork of [sodiboo/niri-flake](https://github.com/sodiboo/niri-flake) ⭐ 972 | 🐛 78 | 🌐 Nix | 📅 2026-08-17).
...
* [miri](https://github.com/MintyDoggo/miri) ⭐ 102 | 🐛 11 | 🌐 Rust | 📅 2026-06-21 - A niri extension adding per-workspace tiling layouts, such as Master Stack, similar to hyprland or mangowm.
...
* [oniri](https://github.com/Antiz96/oniri) ⭐ 48 | 🐛 1 | 🌐 Rust | 📅 2026-08-17 - A tool that automatically maximizes the only window in a workspace.
...
* [Anyrun](https://github.com/anyrun-org/anyrun) ⭐ 1,289 | 🐛 73 | 🌐 Rust | 📅 2026-08-14 - A Wayland native krunner-like runner, made with customizability in mind. Provides [niri-focus](https://github.com/anyrun-org/anyrun/blob/master/plugins/niri-focus/README.md) ⭐ 1,289 | 🐛 73 | 🌐 Rust | 📅 2026-08-14 plugin.
...
* [Waybar](https://github.com/Alexays/Waybar) ⭐ 11,815 | 🐛 712 | 🌐 C++ | 📅 2026-08-14 - Highly customizable Wayland bar based on GTK.
* [Ironbar](https://github.com/JakeStanger/ironbar) ⭐ 1,433 | 🐛 125 | 🌐 Rust | 📅 2026-08-17 - A customisable Wayland GTK bar written in Rust.
...
* [vibepanel](https://github.com/prankstr/vibepanel) ⭐ 160 | 🐛 3 | 🌐 Rust | 📅 2026-08-17 - A GTK4 panel for Wayland with integrated notifications, OSD, and quick settings.
* [Niri Taskbar](https://github.com/LawnGnome/niri-taskbar) ⭐ 151 | 🐛 29 | 🌐 Rust | 📅 2025-12-04 - Provides a Waybar taskbar module for niri.
* [i3bar-river](https://github.com/MaxVerevkin/i3bar-river) ⭐ 86 | 🐛 23 | 🌐 Rust | 📅 2025-05-19 - A port of i3bar for Wayland compositors, to be used with something like [i3status-rust](https://github.com/greshake/i3status-rust) ⭐ 3,135 | 🐛 120 | 🌐 Rust | 📅 2026-08-15.
...
* [Noctalia](https://github.com/Ly-sec/Noctalia) ⭐ 9,577 | 🐛 248 | 🌐 C++ | 📅 2026-08-17 - A sleek and minimal desktop shell built with Quickshell.
* [DankMaterialShell](https://github.com/AvengeMedia/DankMaterialShell) ⭐ 7,625 | 🐛 449 | 🌐 QML | 📅 2026-08-17 - Quickshell based shell featuring Material 3 design principles, with a heavy focus on functionality and customizability.
* [iNiR](https://github.com/snowarch/iNiR) ⭐ 1,431 | 🐛 23 | 🌐 QML | 📅 2026-08-12 - [end-4's quickshell config](https://github.com/end-4/dots-hyprland) ⭐ 15,632 | 🐛 631 | 🌐 QML | 📅 2026-08-15 modified to work with niri.
* [Exo](https://github.com/debuggyo/Exo) ⭐ 682 | 🐛 13 | 🌐 Python | 📅 2026-01-16 - A Material 3 inspired desktop shell created with Ignis.
...
* [Glimpse](https://github.com/alex-oleshkevich/glimpse) ⭐ 1 | 🐛 1 | 🌐 Rust | 📅 2026-08-17 - A niri-first Wayland desktop shell toolkit with a panel, wallpaper, lock screen, night light, and idle management.
...
* [niri on Cosmic](https://github.com/Drakulix/cosmic-ext-extra-sessions) ⭐ 181 | 🐛 15 | 🌐 Shell | 📅 2025-04-02 - A Cosmic extension that allows niri as a session option, allowing you to use niri with the [Cosmic desktop environment](https://github.com/pop-os/cosmic-epoch) ⭐ 6,650 | 🐛 1,792 | 🌐 Just | 📅 2026-07-29.
...
* [Setup Showcase](https://github.com/niri-wm/niri/discussions/325) ⭐ 26,961 | 🐛 488 | 🌐 Rust | 📅 2026-08-14 - A showcase of niri setups, where users can share their configurations and get inspiration from others.
